  ...
  return (
    <section className={classes.BrandingSteps}>
      <Container fixed className={classes.Container}>
        <Grid container>
          <Fade up><h2 className={classes.Headding}>Услуги брендинга</h2></Fade>
        </Grid>
        <Grid container sm={12} xs={12} className={classes.Cards}>
          ...
          <Grid item container sm={6} xs={12} className={classes.Card} justify="center" alignItems="center">
            <Fade up><p className={classes.Text}>Веб-студия 16.web готова взять на себя разработку вашего бренда – мы обеспечим всё, что необходимо для позиционирования торговой марки.</p></Fade>
          </Grid>
        </Grid>
      </Container>
    </section>
