    ...
    <>
      <section className={classes.LandingCoast}>
        <Container fixed className={classes.Container}>
          <Fade up><h2 className={classes.Headding}>От чего зависит стоимость лендинга?</h2></Fade>
          <Grid container>
            <Grid item container sm={6} xs={12} className={classes.LeftColumn}>
              <Fade up><img className={classes.LandingCoastImg} src={LandingCoastImg} alt=""/></Fade>
            </Grid>
        ...
        <Container fixed>
          <Grid container>
            <Grid item container sm={6} xs={12}>
              <Fade up><h2 className={classes.Headding}>Индивидуальный подход</h2></Fade>
            </Grid>
            <Grid item container sm={6} xs={12}>
              <Fade up><p className={classes.Text}>Мы интегрируем созданные нами сайты с программным обеспечением 1С и TecDoc – это делает более простой и эффективной работу с остатками, ценами и ассортиментом, а также обеспечивает автоматическое обновление каталога и карточек товаров в случае каких-либо изменений.</p></Fade>
            </Grid>
          </Grid>
        </Container>
      </section>
