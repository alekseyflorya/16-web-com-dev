        ...
        <Grid container>
          ...
          <Grid item container className={classes.BottomRow}>
            <Grid item container sm={6} xs={12} className={classes.Item}>
              <Link to="/seo-audit" className={classes.Title}>SEO-аудит сайта</Link>
            ...
            <Grid item container sm={6} xs={12} className={classes.Item}>
              <Link to="/semantic-core" className={classes.Title}>Составление семантического ядра</Link>
            ...
            <Grid item container sm={6} xs={12} className={classes.Item}>
              <Link to="/internal-optimization" className={classes.Title}>Внутренняя оптимизация сайта</Link>
            ...
            <Grid item container sm={6} xs={12} className={classes.Item}>
              <Link to="/external-optimization" className={classes.Title}>Внешняя оптимизация сайта</Link>
