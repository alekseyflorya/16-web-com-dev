      ...
      <section className={classes.OnlinestoreIntegration}>
        <Container fixed>
          <Grid container>
            ...
            <Grid item container sm={6} xs={12}>
              <p className={classes.Text}>Мы используем полный набор инструментов, способствующих увеличению охвата клиентов - интегрируем в лендинг квизы, лид-формы, телеграм-каналы с настроенными ботами, гугл-таблицы. При этом структура ресурса во многом определяется задачами, поставленными заказчиком, и спецификой его деятельности.</p>
            </Grid>
          </Grid>
        </Container>
      </section>
